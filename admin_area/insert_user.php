               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <input name="admin_contact" type="text" class="form-control" >
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                        ...
                        <textarea name="admin_about" class="form-control" cols="30" rows="3"></textarea> 
...
if(isset($_POST['submit'])){
    ...
    $insert_user = "insert into admins (admin_name,admin_email,admin_pass,admin_image,admin_country,admin_about,admin_contact,admin_job) values ('$user_name','$user_email','$user_pass','$admin_image','$user_country','
    $user_about','$user_contact','$user_job')";
