               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="product_images/<?php echo $p_image1; ?>" width="70" height="70" alt="<?php echo $p_image1; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="product_images/<?php echo $p_image2; ?>" width="70" height="70" alt="<?php echo $p_image2; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img src="product_images/<?php echo $p_image3; ?>" width="70" height="70" alt="<?php echo $p_image3; ?>">
